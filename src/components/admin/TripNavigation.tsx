...
interface NavProps {
  tripId?: string;                 // opzionale: fallback da URL
  activeTab: TabId;                // tipizzato
...
const AdminTripNavigation: React.FC<NavProps> = ({ tripId, activeTab, badges }) => {
  ...
  const hasTripId = Boolean(finalTripId && finalTripId !== "undefined" && finalTripId !== "null");
...
export default AdminTripNavigation;
