        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm flex items-center gap-6">
            ...
            <div>
              ...
              <span className="text-3xl font-black text-slate-900">{kpis.total}</span>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm flex items-center gap-6">
            ...
            <div>
              ...
              <span className="text-3xl font-black text-slate-900">{kpis.todayInFiltered}</span>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm flex items-center gap-6">
            <div
              className={`p-4 rounded-2xl ${
                kpis.criticalInFiltered > 0 ? 'bg-rose-50 text-rose-600' : 'bg-slate-50 text-slate-400'
              }`}
            >
              <ShieldAlert size={24} />
            </div>
            <div>
              ...
              <span
                className={`text-3xl font-black ${
                  kpis.criticalInFiltered > 0 ? 'text-rose-600' : 'text-slate-900'
                }`}
              >
              ...
              {(['TODAY', '7DAYS', '30DAYS'] as const).map((range) => (
                <button
                  ...
                  className={`px-4 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                    dateRange === range ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-400'
                  }`}
                >
                ...
                >
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] font-bold text-slate-700">{event.actor.emailMasked}</span>
                    </div>
                  </td>
                </tr>
              ))}
          ...
          <div className="relative w-full max-w-xl bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-500">
            ...
            <div className="flex-1 overflow-y-auto p-10 space-y-10">
              <div className="bg-slate-50 p-8 rounded-[32px] border border-slate-100">
                <p className="text-lg font-medium text-slate-700 italic">"{selectedEvent.note}"</p>
              </div>
              ...
              <div>
                ...
                <pre className="bg-slate-900 text-indigo-300 p-8 rounded-[32px] text-xs font-mono overflow-x-auto">
